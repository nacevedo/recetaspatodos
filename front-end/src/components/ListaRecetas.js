...
class ListaRecetas extends React.Component {
  ...
  render() {
    ...
    else if (a.length == 1 && a[0].nombre == "vacio")
      return (
        <div className="col-md-9">
          <div className="container">
            <h1>No se ha encontrado ninguna receta con esos ingredientes</h1>
          </div>
        </div>
      );
    return (
        ...
        <div className="row">
          {a.map(r => (
            <div key={r._id} className="col-md-4">
              <img
                src={r.imagen}
                onClick={this.openModal.bind(this, r._id)}
                alt=""
                width="100%"
                height="200px"
              />
